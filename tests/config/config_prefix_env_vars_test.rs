...
fn test_env_vars_success() {
    ...
    // run
    let cfg = Config::new().with_env_prefix("ENV_").build::<Cfg>();
    dbg!(&cfg);
    // assert
    assert!(&cfg.is_ok());
    let cfg = cfg.unwrap();
...
fn test_env_vars_nested_default_success() {
    ...
    struct CfgNestedNested {
        ...
        #[serde(alias = "ENV_INT_NESTED_NESTED")]
        int: i64,
        #[serde(alias = "ENV_FLOAT_NESTED_NESTED", default)]
        float: f64,
        #[serde(alias = "ENV_BOOL_NESTED_NESTED")]
        boolean: bool,
    }
    ...
    assert_eq!(cfg.cfg_nested.string, "anu");
    assert_eq!(cfg.cfg_nested.boolean, true);
    assert_eq!(cfg.cfg_nested.int, 0);
    assert_eq!(cfg.cfg_nested.float, 1001.2);
...
fn test_env_vars_nested_default_custom_success() {
    ...
    struct CfgNestedNested {
        ...
        #[serde(alias = "ENV_INT_NESTED_NESTED")]
        int: i64,
        #[serde(alias = "ENV_FLOAT_NESTED_NESTED", default = "default_float")]
        float: f64,
        #[serde(alias = "ENV_BOOL_NESTED_NESTED")]
        boolean: bool,
    }
    ...
    assert_eq!(cfg.cfg_nested.cfg_nested_nested.string, "default_anu");
    assert_eq!(cfg.cfg_nested.cfg_nested_nested.boolean, true);
    assert_eq!(cfg.cfg_nested.cfg_nested_nested.int, 123);
